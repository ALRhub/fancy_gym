...
if __name__ == "__main__":
    ...
    test_mp_env(env_id="7dof-hit-promp", seed=1, iteration=100, plot_result=False)
    # test_mp_replan_env(env_id="3dof-hit-prodmp-replan", seed=1, iteration=3)
